...
const UploadModal = () => {
  ...
  const onSubmit: SubmitHandler<FieldValues> = async (values) => {
    try {
      ...
      .upload(`song-${values.title}-${uniqueID}.mp3`, songFile, {cacheControl: '3600', upsert: false})
      ...
      .upload(`image-${values.title}-${uniqueID}.mp3`, imageFile, {cacheControl: '3600', upsert: false})
